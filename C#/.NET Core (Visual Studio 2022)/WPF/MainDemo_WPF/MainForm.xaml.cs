    ...
    public partial class MainForm : Window
    {
        ...
        private void VideoGrabber1_OnFrameBitmap(object sender, VidGrab.TOnFrameBitmapEventArgs e)
        {
            ...
            // ============
            {
                ...
                {
                    System.Drawing.Graphics MyGraphics = Graphics.FromHdcInternal(FrameBitmapInfo.bitmapDC);

                    System.Drawing.Pen p = new System.Drawing.Pen(System.Drawing.Color.Blue);
                    System.Drawing.SolidBrush b = new System.Drawing.SolidBrush(System.Drawing.Color.Blue);
                ...
                if (frmOverlays_edtDrawGrid > 1)
                {
                    ...
                    System.Drawing.SolidBrush b = new System.Drawing.SolidBrush(System.Drawing.Color.Aqua);
                ...
                { // see the VideoGrabberMouse... events;
                    ...
                    System.Drawing.Graphics MyGraphics = System.Drawing.Graphics.FromHdcInternal(FrameBitmapInfo.bitmapDC);
        ...
        private void VideoGrabber1_OnFrameCaptureCompleted(object sender, VidGrab.TOnFrameCaptureCompletedEventArgs e)
        {
            ...
            if (e.destType == VidGrab.TFrameCaptureDest.fc_TBitmap)
            {
                ...
                frm_SnapForm.SnapImage.Source = Imaging.CreateBitmapSourceFromHBitmap(e.frameBitmapHandle, IntPtr.Zero, Int32Rect.Empty, System.Windows.Media.Imaging.BitmapSizeOptions.FromEmptyOptions());
                frm_SnapForm.Show();
            }
        }
        ...
        private void VideoGrabber1_OnMotionDetected(object sender, VidGrab.TOnMotionDetectedEventArgs e)
        {
            ...
            {
                tabitem_MotionDetection.imgMotionDetected.Source = Imaging.CreateBitmapSourceFromHBitmap(FrameBitmap, IntPtr.Zero, Int32Rect.Empty, System.Windows.Media.Imaging.BitmapSizeOptions.FromEmptyOptions());
