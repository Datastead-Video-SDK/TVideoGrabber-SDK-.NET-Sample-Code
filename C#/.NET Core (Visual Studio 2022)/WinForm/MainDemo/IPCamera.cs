...
namespace MainDemo
{
    ...
    public partial class IPCamera : Form
    {
        ...
        {
            lblFirstSelectIPCamera.Visible = (MainForm.cMainForm.VideoGrabber1.VideoSource != VidGrab.TVideoSource.vs_IPCamera);
        }
        ...
        {
            MainForm.cMainForm.VideoGrabber1.SetAuthentication(VidGrab.TAuthenticationType.at_IPCamera, edtIPCamUserName.Text, edtIPCamPassword.Text);
        }
        ...
        private void edtIPCamConnectionTimeout_TextChanged(object sender, System.EventArgs e)
        {
            ...
            {
                MainForm.cMainForm.VideoGrabber1.SetIPCameraSetting(VidGrab.TIPCameraSetting.ips_ConnectionTimeout, Convert.ToInt32(edtIPCamConnectionTimeout.Text));
            }
        }
        ...
        private void edtIPCamReceiveTimeout_TextChanged(object sender, System.EventArgs e)
        {
            ...
            {
                MainForm.cMainForm.VideoGrabber1.SetIPCameraSetting(VidGrab.TIPCameraSetting.ips_ReceiveTimeout, Convert.ToInt32(edtIPCamReceiveTimeout.Text));
            }
        }

        private void btnIPCamStartPreview_Click(object sender, System.EventArgs e)
        {
            if (MainForm.cMainForm.VideoGrabber1.VideoSource != VidGrab.TVideoSource.vs_IPCamera)
            {
                MainForm.cMainForm.VideoGrabber1.VideoSource = VidGrab.TVideoSource.vs_IPCamera;
                Helpers.AddLog(MainForm.cMainForm.mmoLog, "VideoSource set to 'vs_IPCamera'");
            }
